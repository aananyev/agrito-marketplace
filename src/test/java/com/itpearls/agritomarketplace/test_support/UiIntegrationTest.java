package com.itpearls.agritomarketplace.test_support;

import com.itpearls.agritomarketplace.AgritoMarketplaceApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.itpearls.agritomarketplace.screen")
@ContextConfiguration(classes = {AgritoMarketplaceApplication.class, UiTestAssistConfiguration.class})
